      ...
      <div className="relative z-10 min-h-screen p-8 pt-24">
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="flex gap-8">
            ...
            <div className="w-80 bg-gradient-to-br from-slate-900/90 to-slate-800/90 backdrop-blur rounded-2xl p-6 border border-yellow-400/20 shadow-2xl hover:shadow-yellow-400/10 transition-all duration-500 overflow-y-auto max-h-[calc(100vh-200px)]">
              <h2 className="text-2xl font-bold text-white mb-6 bg-gradient-to-r from-white to-yellow-400 bg-clip-text text-transparent">Plot Details</h2>
              ...
              {selectedPlot ? (
                <div className="space-y-4 animate-fade-in">
                  <div className="bg-gradient-to-br from-yellow-400/10 to-yellow-600/10 border border-yellow-400/30 rounded-xl p-4">
                    ...
                    <p className="text-4xl font-bold text-yellow-400">#{selectedPlot}</p>
                  </div>
                  ...
                  <div className="bg-slate-800/50 border border-slate-700 rounded-xl p-4">
                    ...
                    <span className="inline-block px-4 py-2 bg-green-500/20 border border-green-500 text-green-400 text-sm font-semibold rounded-full animate-pulse">
                      ✓ Available Now
                    </span>
                  </div>
                  <div className="bg-slate-800/50 border border-slate-700 rounded-xl p-4">
                    ...
                    <p className="text-white font-medium mb-1">Prime location near NH-4</p>
                    <p className="text-sm text-gray-400">Between Bangalore & Tirupathi</p>
                  </div>

                  <div className="bg-gradient-to-br from-green-500/10 to-blue-500/10 border border-green-500/30 rounded-xl p-4">
                    <p className="text-gray-300 text-sm mb-2 font-semibold">✨ Amenities</p>
                  ...
                  <button
                    ...
                    className="w-full mt-6 px-4 py-4 bg-gradient-to-r from-yellow-400 to-yellow-500 hover:from-yellow-500 hover:to-yellow-600 text-black font-bold rounded-xl transition-all hover:shadow-2xl hover:shadow-yellow-400/40 hover:scale-105 transform duration-300"
                  >
